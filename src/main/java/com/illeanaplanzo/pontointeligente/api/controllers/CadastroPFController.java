...
import com.illeanaplanzo.pontointeligente.api.dtos.CadastroPFDto;
...
public class CadastroPFController {
	...
	public CadastroPFController() {
		...
		/**
		 * Cadastra um funcionário pessoa fisica no sistema.
		 * 
		 * @param cadastroPFDto
		 * @param result
		 * @returns ResponseEntity<Response<CadastroPFDto>>
	...
	/**
	 * Verifica se a empresa está sendo cadastrada e se o funcionario não existe na base de dados.
	 * 
	 * @param cadastroPFDto
	 * @param result
	 */
